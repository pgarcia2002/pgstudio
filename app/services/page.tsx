...
const T = "var(--font-title), sans-serif"   // Jost / Futura-like
const S = "var(--font-syne), sans-serif"    // Josefin Sans / body
const P = "var(--font-cormorant), serif"    // Playfair Display / italic accents
...
export default function ServicesPage() {
  return (
    <main style={{ background: "#080808" }}>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                >
                  {[
                    "Modifications de contenu (textes, images)",
      ...
      {/* ── Process ── */}
      <section style={{ padding: "96px 48px", borderBottom: "1px solid rgba(240,237,232,0.1)" }}>
        <AnimatedSection>
          <p
            style={{
              fontFamily: S,
